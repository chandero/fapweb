 ...
 */
    ...
    def calcularFechasALiquidarVarAnticipada(fecha_inicial: DateTime, fecha_corte: DateTime, fecha_proxima: DateTime):List[FechaLiq] = {
        var _list = new ListBuffer[FechaLiq]()
        ...
        while(_fechaf1.getMillis() <= _fechaf3.getMillis()) {
          _fecha = _fechaf3
          if ( (_fecha.getMillis() > _fechaf4.getMillis()) && (_paso == false) && (_fechaf1.getMillis() < _fechaf4.getMillis())) {
             _fecha = _fechaf4
             _paso = true
          }
          ...
          if ( (_fecha.getMillis() <= _fechaf4.getMillis()) && (_fechaA == _fechaB) ){
            _anticipado = false
            _causado = false
            _corriente = true
            _vencido = false
