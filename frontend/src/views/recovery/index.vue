<template>
  <div class="recovery-container">
    <el-form v-show="!comingsoon" ref="recoveryForm" :model="recoveryForm" label-position="left" class="recovery-form" auto-complete >
      ...
      <el-form-item prop="username">
        ...
        <el-input v-model="recoveryForm.username" :placeholder="$t('recovery.username')" name="username" type="text" auto-complete />
      </el-form-item>
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleSend">{{ $t('recovery.send') }}</el-button>
    </el-form>
    <el-dialog
