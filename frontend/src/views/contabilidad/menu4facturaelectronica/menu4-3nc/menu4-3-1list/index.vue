<template>
  <el-container>
    <el-main>
      ...
      <el-row :gutter="4">
        <el-col :span="24">
          <el-button primary>Nueva Nota Crédito</el-button>
        </el-col>
      </el-row>
      </el-container>
    </el-main>
...
import { getNotasCredito } from '@/api/factura'
...
export default {
  ...
  methods: {
    ...
    getData () {
      getNotasCredito(this.page_size, this.current_page, this.filter, this.order).then(response => {
