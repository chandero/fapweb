<template>
  <el-container>
    <el-main>
        ...
        <el-row>
          <el-col>
            ...
            >
              ...
              <el-table-column label="DSA" width="100">
                <template slot-scope="scope">
      ...
      <el-row>
        <el-col :span="24">
          <el-button type="primary" @click="drawer = true">Nueva Nota Crédito DSA</el-button>
        </el-col>
      </el-row>
    </el-main>
    <el-drawer
...
import { getNotasCreditoDSA, enviarNotaCreditoDSA, getFacturaProveedor } from "@/api/factura"
  ...
  methods: {
    ...
    reEnviar(fact_nota_numero) {
      this.$confirm('Seguro de Reenviar la Nota Crédito ' + fact_nota_numero + '?', 'Confirmación', {
          ...
          enviarNotaCreditoDSA(fact_nota_numero).then(response => {
