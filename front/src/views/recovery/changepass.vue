<template>
  <div class="changepass-container">
    <el-form ref="changePassForm" :model="changePassForm" label-position="left" class="changepass-form" auto-complete>
      ...
      <el-form-item prop="password">
        ...
        <el-input v-model="changePassForm.password" :type="passwordType" :placeholder="$t('changepass.password')" name="password" />
      ...
      <el-form-item prop="repassword">
        ...
        <el-input :change="validatePassword()" :type="repasswordType" v-model="changePassForm.repassword" :placeholder="$t('changepass.repassword')" name="repassword" />
        <span class="show-repwd" @click="showRePwd">
          <svg-icon icon-class="eye" />
        </span>
      </el-form-item>
      <p/>
      <el-button :disabled="!send" :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="handleSend">{{ $t('changepass.change') }}</el-button>
    </el-form>
  </div>
</template>
